package com.lihang.selfmvvmbykotlin.retrofitwithrxjava.Interceptor;

import android.text.TextUtils;


import com.lihang.selfmvvmbykotlin.utils.PreferenceUtil;
...
public class NetCacheInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        //(到时候最好用csdn登录来做)
        String token = (String) PreferenceUtil.INSTANCE.get("USER_TOKEN", "");
        ...
        if (list.size() > 0) {
            PreferenceUtil.INSTANCE.put("USER_TOKEN", list.get(0));
        }
