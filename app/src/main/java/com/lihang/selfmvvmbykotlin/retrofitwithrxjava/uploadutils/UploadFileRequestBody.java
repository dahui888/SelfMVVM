package com.lihang.selfmvvmbykotlin.retrofitwithrxjava.uploadutils;
...
public class UploadFileRequestBody extends RequestBody {
    ...
    protected final class CountingSink extends ForwardingSink {
        ...
        public void write(Buffer source, long byteCount) throws IOException {
            ...
            if (liveData != null) {
                liveData.postValue(Resource.Companion.progress((int) (bytesWritten * 100 / contentLength()), contentLength()));
            }
        }
    }
}
